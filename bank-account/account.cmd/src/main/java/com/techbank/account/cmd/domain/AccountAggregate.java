...
public class AccountAggregate extends AggregateRoot {
  ...
  public void depositFunds(double amount) {
    if (this.active)
      throw new IllegalStateException("Funds cannot be deposited onto a closed account");
    if (amount <= 0) throw new IllegalStateException("Amount should be greater than zero");
  ...
  public void withdrawFunds(double amount) {
    if (this.active)
      throw new IllegalStateException("Funds cannot be withdrawn onto a closed account");
